...
* Hot loading of business logic and demonstrates how it is done for maintainaing the current program state in your business code while bug code fixing and debugging.
...
* The ability to build independent react web components with the react UI part of the component free of business logic.
...
* Css inline, modules and legacy support for less, sass, scss and css. Also supports the postcss-loader for vendor css prefixes. 
...
* Allows you to see your production code after a build.
...
## Production Build
* npm run build (Outside vscode).
* Display the task list and select "Build Production" (Inside vscode).

## Run Production Code
* Select the debug button to the left in vscode and select "Production" from the drop down. Then push the green arrow button next to the dropdown. (Note: running the production code does not perform a production build.)
...
* Build development dlls - Use this if you do not use dlls in your production build.
    * npm run builddll:dev (Outside vscode).
    * See the keybaord shortcuts for building inside vscode.
* Build development & production dlls - Use this if you use dlls in your production build.
    * npm run builddll (Outside vscode).
    * See the keybaord shortcuts for building inside vscode.

## React/Enzyme Test Run and Debugging
* npm run test (Outside vscode).
* Select the debug button to the left in vscode and select "Mocha Tests" from the drop down. (Inside vscode for debugging test code). Then push the green arrow button next to the dropdown. **Note, set the key "program" in the launch.json file under "Mocha Tests" to the location of your mocha program. Currently, it is "program": "${workspaceRoot}/node_modules/mocha/bin/_mocha".**
...
* Major extensions amnd simplifications to redux.
